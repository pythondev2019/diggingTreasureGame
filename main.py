...
healthBar = Progressbar(f, orient=HORIZONTAL, length=100, value=100, maximum=100, mode='determinate')
healthBar.grid(row=0, column=0)
...
Button(infof, text='Instructions', width=8, command=lambda: messagebox.showinfo('Instructions', 'instructions')).grid(
    row=0, column=2)
