...
def main_menu(player):
    ...
    name_label = Label(
                       ...
                       label = Label(
                                     frame_input,
                                     text="Welcome to Digging Treasure game!",
                       ...
                       new_game_button = Button(
                                                ...
                                                fg="white",
                                                command=lambda: new_game(root, name.get()),
                                                )
                       new_game_button.grid(row=0, column=0)
                       
                       view_top_button = Button(
                                                button_frame,
                                                text="View top",
                                                width=8,
                                                bg="blue",
...
for i in range(1, 11):
    if not (top_players):
        ...
        label = Label(
                      frame_text, text=curr_player_score[0], fg="green", font="Helvetica"
                      )
